 ...
 * @package App\Models
 */
class InternacionMovilidad extends Model
{
	protected $table = 'internacion_movilidad';
	...
	{
		return $this->hasMany(InternacionHojaIndicacione::class, 'movilidad_id');
	}
}
