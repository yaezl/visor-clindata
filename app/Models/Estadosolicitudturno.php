 ...
 * @property bool $seleccionable_cema
 * @property bool $seleccionable_caps
 ...
 * @package App\Models
 */
class Estadosolicitudturno extends Model
{
	protected $table = 'estadosolicitudturno';
	...
	protected $casts = [
		...
		'seleccionable_cema' => 'bool',
		'seleccionable_caps' => 'bool',
		'creado_en' => 'datetime',
