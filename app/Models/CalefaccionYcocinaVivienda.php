...
/**
 * Class CalefaccionYcocinaVivienda
 * 
 * @property int $id
 ...
 * @package App\Models
 */
class CalefaccionYcocinaVivienda extends Model
{
	protected $table = 'calefaccion_ycocina_vivienda';
	...
	{
		return $this->hasMany(PersonaVivienda::class, 'calefaccionycocina_id');
	}
}
