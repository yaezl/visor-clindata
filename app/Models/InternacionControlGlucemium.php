...
/**
 * Class InternacionControlGlucemium
 * 
 * @property int $id
 ...
 * @package App\Models
 */
class InternacionControlGlucemium extends Model
{
	protected $table = 'internacion_control_glucemia';
	...
	{
		return $this->hasMany(InternacionHojaIndicacione::class, 'control_glucemia_id');
	}
}
