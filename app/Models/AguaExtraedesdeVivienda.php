 ...
 * @package App\Models
 */
class AguaExtraedesdeVivienda extends Model
{
	protected $table = 'agua_extraedesde_vivienda';
	...
	{
		return $this->hasMany(PersonaVivienda::class, 'aguaextraedesde_id');
	}
}
