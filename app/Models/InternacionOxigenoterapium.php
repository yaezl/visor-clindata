...
/**
 * Class InternacionOxigenoterapium
 * 
 * @property int $id
 ...
 * @package App\Models
 */
class InternacionOxigenoterapium extends Model
{
	protected $table = 'internacion_oxigenoterapia';
	...
	{
		return $this->hasMany(InternacionHojaIndicacione::class, 'oxigenoterapia_id');
	}
}
