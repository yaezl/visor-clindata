 ...
 * @package App\Models
 */
class InternacionDietum extends Model
{
	protected $table = 'internacion_dieta';
	...
	{
		return $this->hasMany(InternacionHojaIndicacione::class, 'dieta_id');
	}
}
