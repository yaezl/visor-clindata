...
/**
 * Class CondicionTenenciaVivienda
 * 
 * @property int $id
 ...
 * @package App\Models
 */
class CondicionTenenciaVivienda extends Model
{
	protected $table = 'condicion_tenencia_vivienda';
	...
	{
		return $this->hasMany(PersonaVivienda::class, 'condiciontenencia_id');
	}
}
