 ...
 * @package App\Models
 */
class PastoralNecesidad extends Model
{
	protected $table = 'pastoral_necesidad';
	...
	{
		return $this->hasMany(PastoralEventoNecesidad::class, 'necesidad_id');
	}
}
