...
/**
 * Class AguaProvienedesdeVivienda
 * 
 * @property int $id
 ...
 * @package App\Models
 */
class AguaProvienedesdeVivienda extends Model
{
	protected $table = 'agua_provienedesde_vivienda';
	...
	{
		return $this->hasMany(PersonaVivienda::class, 'aguaprovienedesde_id');
	}
}
