...
/**
 * Class InternacionConsistencium
 * 
 * @property int $id
 ...
 * @package App\Models
 */
class InternacionConsistencium extends Model
{
	protected $table = 'internacion_consistencia';
	...
	{
		return $this->hasMany(InternacionHojaIndicacione::class, 'consistencia_id');
	}
}
